...
public class ASIA4JTestIT {
    ...
    public void testClustering() {
        Assert.assertEquals("\"/Haus/Sicherheit zu Hause,/Haus/Sicherheit zu Hause/In-Home-Gefahrenmelder," +
                ...
                client.extendKeywordsCategories("1 zu 4 demultiplexer"));
    }
    ...
    public void testCustomEventMatch() {
        ...
        Assert.assertEquals("",
                client.extendCustomEventID(conditions));
    ...
    public void testCustomEventSelect() {
        ...
        Assert.assertEquals("13541152",
                client.extendCustomEvent(ids, propIds));
    }
    ...
    public void testMediaAttention() {
        ...
        Assert.assertEquals("27.0",
                client.extendMediaAttention(offset, feature, category, startDate, endDate, aggregator));
    }
